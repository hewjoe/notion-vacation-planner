...
if not database_id:
    ...
    print("Will only test API authentication, not database access.")
...
try:
    ...
    # If database ID is provided, try to access it
    if database_id:
        try:
            ...
            if results:
                        ...
                        if prop_type == "title":
                            ...
                            if relation_ids:
                                ...
                                for rel_id in relation_ids[:2]:  # Limit to first 2 relations
                                    related_titles.append(get_related_page_title(notion, rel_id))
                ...
                print("\nVerify these records match what you expect to see in your database.")
            
        except Exception as e:
            print(f"\n❌ Error accessing database: {e}")
            print("Please check your NOTION_DATABASE_ID and make sure you have access to this database.")
...
print("1. Ensure your Notion integration has been added to your database")
